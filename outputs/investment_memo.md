# Infosys Valuation & Modeling Memo

## Recommendation

Base-case DCF value is INR 1,126 per share, implying -25.0% versus the illustrative market price in the assumptions file. The LBO base case generates a 7.7% sponsor IRR, which is modest because Infosys is already large, cash-rich, mature, and difficult to lever aggressively without changing its conservative capital structure.
...
- Base transaction funding uses INR 78,568 crore of acquisition debt and INR 402,268 crore of sponsor equity.
...
![LBO IRR sensitivity](C:/Work/Finance Projects/outputs/lbo_irr_sensitivity.png)
